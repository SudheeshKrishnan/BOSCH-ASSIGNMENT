package com.bosch.assignment.employee.jwt;
...
public class JWTWebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable().exceptionHandling()
				...
				.antMatchers(HttpMethod.POST, "/project").access("hasRole('ROLE_USER_1')")
				.antMatchers(HttpMethod.POST, "/department").access("hasRole('ROLE_USER_2')").anyRequest().authenticated();
